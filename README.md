...
## Credits
This project was made with the [Chat GPT Library for Rust](https://github.com/Arend-Jan/chat-gpt-lib-rs), which provides a Rust API for the OpenAI GPT language model.
